...
<div class="breadcumb-wrapper background-image" style="background-image: url(&quot;assets/img/breadcumb/breadcumb-bg.jpg&quot;);">
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Pesquisa de Satisfação</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 mb-30">
                            <div class="contact-box">
                                <h3 class="contact-box__title h4">Pesquisa de Satifação</h3>
                                <p class="contact-box__text">Em virtude do sistema contínuo da qualidade, visando a melhoria contínua de nossos serviços, solicitamos o preenchimento das respostas abaixo, para que possamos melhorar a cada dia o nosso atendimento.</p>
                                <form class="contact-box__form ajax-contact" action="mail.php" method="POST">
                                    <div class="row gx-20">
                                        ...
                                        <div class="col-md-6 form-group">
                                            <input type="text" name="name" id="name" placeholder="Nome / Função">
                                            <i class="fal fa-user"></i>
                                        </div>
                                        <div class="col-md-6 form-group">
                                            <input type="email" name="email" id="email" placeholder="Você Está Sendo Bem Atendido?">
                                            <i class="fal fa-envelope"></i>
                                        </div>
                                      
                                        <div class="col-12 form-group">
                                            <textarea name="message" id="message" placeholder="Você tem alguma sugestão para melhoria dos nossos serviços ?"></textarea>
                                        </div>

                                        <div class="col-md-6 form-group">
                                            <input type="text" name="name" id="name" placeholder="Quanto ao prazo de entrega, houve atraso, seu pedido foi entregue conforme contratado ?">
                                            <i class="fal fa-user"></i>
                                        </div>
                                        <div class="col-md-6 form-group">
                                            <input type="email" name="email" id="email" placeholder="Quanto à embalagem, é adequada às suas necessidades ?">
                                            <i class="fal fa-envelope"></i>
                                        </div>

                                        <div class="col-md-12 form-group">
                                            <input type="text" name="name" id="name" placeholder="Quanto à documentação, atende sua necessidade, o material está devidademente documentado ?">
                                            <i class="fal fa-user"></i>
                                        </div>
                                        <div class="col-12 form-group">
                                            <textarea name="message" id="message" placeholder="Comentários:"></textarea>
                                        </div>

                                        <div class="col-12">
                                            <button class="vs-btn">Enviar Formulário<i class="far fa-arrow-right"></i></button>
                                        </div>
                                    </div>
                                </form>
