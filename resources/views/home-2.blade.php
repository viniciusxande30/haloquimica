    ...
    <section class="vs-hero-wrapper position-relative  ">
        <div class="vs-hero-carousel" data-height="850" data-container="1900" data-slidertype="responsive">
            ...
            <div class="ls-slide" data-ls="duration:12000; transition2d:5; kenburnszoom:in; kenburnsscale:1.1;">
                <img width="1920" height="850" src="{{url('/')}}/assets/img/hero/hero-1-1.jpg" class="ls-bg" alt="hero-bg" />
                ...
                <div style="top:405px; left:350px; background-size:inherit; background-position:inherit; font-size:16px; line-height:28px; font-family:Fira Sans; width:695px; color:#ffffff; white-space:normal;" class="ls-l ls-hide-tablet ls-hide-phone ls-text-layer" data-ls="offsetyin:50; durationin:1500; delayin:600; easingin:easeOutQuint; offsetyout:50; durationout:1500; easingout:easeOutQuint; position:relative;">Temos uma série de produtos, entre soluções, indicadores de pH, corantes, reativos e padrões químicos. Confira!</div>
            ...
            <div class="ls-slide" data-ls="duration:12000; transition2d:5; kenburnszoom:out; kenburnsscale:1.1;">
                ...
                <div style="top:405px; left:350px; background-size:inherit; background-position:inherit; font-size:16px; line-height:28px; font-family:Fira Sans; width:695px; color:#ffffff; white-space:normal;" class="ls-l ls-hide-tablet ls-hide-phone ls-text-layer" data-ls="offsetyin:50; durationin:1500; delayin:600; easingin:easeOutQuint; offsetyout:50; durationout:1500; easingout:easeOutQuint; position:relative;">Somos especialistas na
indústria On-shore e Off-shore com atendimento especializado em resolução de problemas com produtos da linha laboratorial.</div>
                <div style="top:495px; left:350px; background-size:inherit; background-position:inherit; font-size:24px;" class="ls-l ls-hide-tablet ls-hide-phone ls-html-layer" data-ls="offsetyin:50; durationin:1500; delayin:900; easingin:easeOutQuint; offsetyout:50; durationout:1500; easingout:easeOutQuint; position:relative;">
                    <div class="ls-btn-group">
                        <a href="" class="vs-btn ls-hero-btn">SAIBA MAIS<i class="far fa-arrow-right"></i></a>
                    </div>
                </div>
    ...
    <div data-bg-src="assets/img/bg/ab-bg-1-1.png">
        <!--==============================
    Features Area
    ==============================-->
        <section class="feature-wrap1  space-top space-extra-bottom">
            <div class="container wow fadeInUp" data-wow-delay="0.2s">
                <div class="row vs-carousel" data-slide-show="3" data-lg-slide-show="2" data-md-slide-show="2">
                    <div class="col-xl-4">
                        <div class="feature-style1" style="height: 450px;">
                            <div class="feature-icon"><img src="assets/img/icon/fe-1-1.png" alt="Features"></div>
                            <h3 class="feature-title h5"><a class="text-inherit" href="service-details.html">Bem Vindos a Haloquímica</a></h3>
                            <p class="feature-text">A Haloquimica É  uma empresa especializada na fabricação de soluções especiais e convencionais para diferentes áreas.</p>
                            <a href="{{url('/')}}/fale-conosco" class="vs-btn style3">Saiba Mais<i class="far fa-long-arrow-right"></i></a>
                        </div>
                    </div>
                    <div class="col-xl-4">
                        <div class="feature-style1"  style="height: 450px;">
                            <div class="feature-icon"><img src="assets/img/icon/fe-1-2.png" alt="Features"></div>
                            <h3 class="feature-title h5"><a class="text-inherit" href="service-details.html">Produtos e Serviços</a></h3>
                            <p class="feature-text">Temos uma série de produtos, entre soluções, indicadores de pH, corantes, reativos e padrões químicos. Confira!</p>
                            <a href="{{url('/')}}/produtos-e-servicos" class="vs-btn style3">Saiba Mais<i class="far fa-long-arrow-right"></i></a>
                        </div>
                    </div>
                    <div class="col-xl-4">
                        <div class="feature-style1"  style="height: 450px;">
                            <div class="feature-icon"><img src="assets/img/icon/fe-1-3.png" alt="Features"></div>
                            <h3 class="feature-title h5"><a class="text-inherit" href="service-details.html">Promoções</a></h3>
                            <p class="feature-text">Temos uma série de produtos em promoção com quantidade limitada.  Aproveite</p>
                            <a href="{{url('/')}}/produtos-em-promocao" class="vs-btn style3">Saiba Mais<i class="far fa-long-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    ==============================-->
        <section class="position-relative space-bottom">
            <span class="about-shape1 d-none d-xl-block">Haloquímica</span>
            <div class="container z-index-common">
                <div class="row gx-60">
                    <div class="col-lg-6 col-xl-5 mb-50 mb-lg-0 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="img-box1">
                            <div class="img-1">
                                <img src="assets/img/about/ab-1-1.png" alt="About image">
                            </div>
                           
                        </div>
                    </div>
                    <div class="col-lg-6 col-xl-7 align-self-center wow fadeInUp" data-wow-delay="0.3s">
                        <span class="sec-subtitle"><i class="fas fa-bring-forward"></i>Temos as Melhores Soluções Químicas</span>
                        <h2 class="sec-title h1">Sobre Nós</h2>
                        <p class="mb-4 mt-1 pb-3">Temos uma ampla linha de produtos para laboratórios , tais como vidrarias, ferragens, porcelanas, papéis filtrantes, reagentes, ligas metálicas, padrões primários, Padrões NIST, BAS, USP, IPT, BP, equipamentos diversos, dentre outros.   </p>
                        <div class="call-media">
                            <div class="call-media__icon"><img src="assets/img/icon/tel-1-1.png" alt="icon"></div>
                            <div class="media-body">
                                <span class="call-media__label">Consulte nossos Especialistas</span>
                                <p class="call-media__info">Entre em Contato<a href="tel:+1120917150">Fone: (11) 2091-7150</a></p>
                            </div>
                        </div>
                        <a href="{{url('/')}}/sobre-nos" class="vs-btn">Saiba Mais<i class="far fa-long-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="row gx-60">
                <div class="col-lg-6 pb-20 pb-lg-0 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="img-box2">
                        ...
                        <div class="img-2"><img src="assets/img/faq/faq-1-2.jpg" alt="FAQ image"></div>
                    </div>
                </div>
                <div class="col-lg-6 align-self-center">
                    <span class="sec-subtitle text-white"><i class="fas fa-bring-forward"></i>Saiba Mais</span>
                    <h2 class="sec-title text-white mb-4 pb-2 h1">Perguntas Frequentes</h2>
                    <div class="accordion accordion-style1" id="faqVersion1">
                        <div class="accordion-item">
                            <div class="accordion-header" id="headingOne">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                Qual é a abrangência do mercado em que a Haloquímica atua?
                                </button>
                            </div>
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#faqVersion1">
                                <div class="accordion-body">
                                    <p> A Haloquímica atua há 31 anos no ramo da Indústria Química Laboratorial, com foco na prestação de serviços e produtos específicos para a indústria On-shore e Off-shore. Isso significa que nossa expertise se estende tanto para ambientes terrestres quanto marítimos, abrangendo uma ampla gama de necessidades e desafios.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <div class="accordion-header" id="headingTwo">
                                ...
                                Como a Haloquímica se tornou especialista na indústria On-shore e Off-shore?
                                </button>
                            </div>
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#faqVersion1">
                                <div class="accordion-body">
                                    <p> Nos últimos anos, a Haloquímica concentrou seus esforços em compreender profundamente as demandas únicas da indústria On-shore e Off-shore. Investimos em pesquisa e desenvolvimento para criar soluções personalizadas que abordam os desafios específicos desses ambientes. Essa dedicação nos permitiu adquirir um profundo conhecimento técnico e experiência prática, solidificando nossa posição como especialistas nesse setor.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <div class="accordion-header" id="headingThree">
                                ...
                                Como a Haloquímica aborda a resolução de problemas relacionados aos produtos da linha laboratorial?
                                </button>
                            </div>
                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#faqVersion1">
                                <div class="accordion-body">
                                    <p> Na Haloquímica, temos um compromisso com a excelência no atendimento ao cliente. Quando se trata da resolução de problemas com produtos da linha laboratorial, oferecemos um atendimento especializado e personalizado. Nossa equipe de profissionais altamente qualificados está pronta para entender as necessidades específicas de cada cliente e fornecer soluções rápidas e eficazes. Valorizamos a comunicação aberta e transparente para garantir que os problemas sejam resolvidos de maneira satisfatória para todos os envolvidos.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row text-center text-lg-start align-items-center justify-content-between">
                <div class="col-lg-auto">
                    <span class="sec-subtitle text-white">Pesquise Diversas Soluções</span>
                    <h2 class="h1 sec-title cta-title1">Confira as Diversas Soluções </h2>
                </div>
                <div class="col-lg-auto">
                    <a href="{{url('/')}}/produtos-e-servicos" class="vs-btn">Saiba Mais<i class="far fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row justify-content-center text-center">
                <div class="col-xl-6">
                    <div class="title-area">
                        <span class="sec-subtitle">Nossa Base de Produtos</span>
                        <h2 class="sec-title h1">Produtos</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6 col-lg-3 process-style1">
                    ...
                    <h3 class="process-title h5">Soluções</h3>
                    <p class="process-text">Transforme desafios em soluções conosco. Explore nossa linha de produtos para resultados precisos e confiáveis.</p>
                </div>
                <div class="col-sm-6 col-lg-3 process-style1">
                    <div class="process-arrow"><img src="assets/img/icon/process-arrow-1-1.png" alt="arrow"></div>
                    <div class="process-icon">
                    ...
                    <h3 class="process-title h5">Indicadores de pH</h3>
                    <p class="process-text">Obtenha insights precisos com nossos indicadores de pH. Eleve sua análise com qualidade e confiança.</p>
                </div>
                <div class="col-sm-6 col-lg-3 process-style1">
                    <div class="process-arrow"><img src="assets/img/icon/process-arrow-1-1.png" alt="arrow"></div>
                    <div class="process-icon">
                    ...
                    <h3 class="process-title h5">Corantes</h3>
                    <p class="process-text">Adicione cores à sua pesquisa com nossos corantes de alta qualidade. Explore possibilidades vibrantes para suas aplicações.</p>
                </div>
                <div class="col-sm-6 col-lg-3 process-style1">
                    <div class="process-arrow"><img src="assets/img/icon/process-arrow-1-1.png" alt="arrow"></div>
                    <div class="process-icon">
                    ...
                    <h3 class="process-title h5">Reativos e Padrões Químicos</h3>
                    <p class="process-text">Avance com confiança usando nossos reativos e padrões químicos. Sua busca por precisão tem o suporte que merece.
    ...
    <section class="vs-blog-wrapper  space-top space-extra-bottom" data-bg-src="assets/img/bg/blog-bg-1-1.jpg">
        <div class="container  wow fadeInUp" data-wow-delay="0.2s">
            <div class="row justify-content-center text-center">
                <div class="col-xl-6">
                    <div class="title-area">
                        <span class="sec-subtitle">Novidades da Semana</span>
                        <h2 class="sec-title h1">Nosso Blog</h2>
                    </div>
                </div>
            </div>
                    ...
                    <div class="vs-blog blog-style1">
                        <div class="blog-img">
                            ...
                            <div class="blog-content">
                                <div class="blog-meta">
                                    <a href="blog.html"><i class="far fa-calendar"></i>30 Agosto, 2023</a>
                                    <a href="blog.html"><i class="fal fa-user"></i>por Admin</a>
                                </div>
                                <h3 class="blog-title h5"><a href="">Notícia 01 </a></h3>
                                <a href="" class="link-btn">Saiba Mais<i class="far fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="vs-blog blog-style1">
                        <div class="blog-img">
                            ...
                            <div class="blog-content">
                                ...
                                <h3 class="blog-title h5"><a href="">Notícia 02 </a></h3>
                                <a href="" class="link-btn">Saiba Mais<i class="far fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="vs-blog blog-style1">
                        <div class="blog-img">
                            ...
                            <div class="blog-content">
                                ...
                                <h3 class="blog-title h5"><a href="">Notícia 03 </a></h3>
                                <a href="" class="link-btn">Saiba Mais<i class="far fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
