...
<a href="https://api.whatsapp.com/send?phone=551120917150&amp;text=Ol%C3%A1,%20gostaria%20de%20saber%20mais%20sobre%20a%20Haloquimica"
  target="_blank" class="btn-whatsapp">
  <img src="https://cybertecontroledepragas.com.br/wp-content/uploads/2020/09/bot%C3%A3o-whatsapp-do-prime-gourmet.png"
    class="btn-whatsapp" title="Suporte Via WhatsApp" alt="Cotação Rápida por WhatsApp">
</a>
      ...
      <div class="modal-body">
        <form id="cnpjForm">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="cnpjInput" placeholder="Digite o CNPJ"
              oninput="mascaraCNPJ(this)" required>
          </div>
        </form>
      </div>
...
<!-- Modal Laudos -->
<div class="modal fade" id="cnpjModalFispq" tabindex="-1" role="dialog" aria-labelledby="cnpjModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        <form id="cnpjForm">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="cnpjInputFispq" placeholder="Digite o CNPJ"
              oninput="mascaraCNPJ(this)" required>
          </div>
        </form>
      </div>
